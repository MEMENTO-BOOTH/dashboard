...
export function LicencesPage({ licences }: { licences: LicenceRow[] }) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-[960px] flex-col gap-6 pt-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Renseigne le client et le code de sa borne pour générer un code d'activation.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {licence ? (
            <div className="mt-5 flex flex-col gap-3 rounded-lg border border-primary/30 bg-primary/5 p-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Licences existantes</CardTitle>
          <CardDescription>{licences.length} licence(s) émise(s).</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
